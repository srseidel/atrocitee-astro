...
/**
 * Script to process mockup images:
 * 1. Move files from src/assets/mockups-new to src/assets/mockups with proper naming
 * 2. Run Astro image optimization on the mockup images
 */
...
// Run Astro image optimization
console.log('\nRunning Astro image optimization...');
try {
  execSync('npx astro build', { stdio: 'inherit' });
  console.log('Image optimization complete!');
} catch (error) {
  console.error('Error running Astro image optimization:', error);
} 